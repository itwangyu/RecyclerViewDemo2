...
//    public static void setLoadingListener(OnNetLoadingListener loadingListener) {
//        RetrofitUtil.loadingListener = loadingListener;
//    }

    public static OnNetLoadingListener loadingListener;
    public static <T> T getApiService(Class<T> tClass,OnNetLoadingListener listener) {
        loadingListener=listener;
        return getApiService(tClass);
    }
    public interface OnNetLoadingListener{
        void onLoading(Subscription subscription);
        void onComplete();
    }
    ...
    public static OkHttpClient getOkHttpInstance() {
        if (client == null) {
             ...
             * 缓存
             */
            final File chachefile = new File(Environment.getExternalStorageDirectory(), "HttpCache");
...
//                if (ApkUtils.isNetworkAvailable(AppAplication.getContext())) {
     ...
     * @return
     */
    public static <T> FlowableTransformer <T,T> getComposer() {
        FlowableTransformer flowableTransformer = (FlowableTransformer) upstream -> upstream
...
//                })
                .doOnSubscribe(subscription -> {
                    ...
                    if (loadingListener != null) {
                        loadingListener.onLoading((Subscription) subscription);
                    }
                })
                .doOnComplete(() -> {
                    if (loadingListener != null) {
